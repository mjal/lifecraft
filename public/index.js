(function () {
  ...
  function lifeData(param_0) {
    return /* LifeData */variant("LifeData", 10, [param_0]);
  }
  ...
  function select_rule(model) {
    var rules_option = function (param) {
      ...
      return option$prime(undefined, undefined, /* :: */simpleVariant("::", [
                    value$1("dropdown-item"),
                    /* :: */simpleVariant("::", [
                        Attributes.selected(model.rule === rule),
                        /* :: */simpleVariant("::", [
                            onClick(/* SetRule */variant("SetRule", 5, [rule])),
                            /* [] */0
                          ])
                      ])
                  ]), /* :: */simpleVariant("::", [
    ...
    return select(undefined, undefined, /* [] */0, map(rules_option, rule_list));
  }
  ...
  function select_backend(model) {
    ...
    return select(undefined, undefined, /* :: */simpleVariant("::", [
                  onChange(undefined, (function (v) {
                          ...
                          return /* SetBackend */variant("SetBackend", 6, [match[1]]);
                        })),
                  /* [] */0
      ...
      return div(undefined, undefined, /* [] */0, /* :: */simpleVariant("::", [
                    div(undefined, undefined, /* :: */simpleVariant("::", [
                            ...
                            /* [] */0
                                ...
                                return view_button(e, /* SetDirectory */variant("SetDirectory", 7, [e]));
                              }), directories)),
                    /* :: */simpleVariant("::", [
                        div(undefined, undefined, /* :: */simpleVariant("::", [
                                class$prime("menu flex"),
                                /* [] */0
                                    ...
                                    var model$1 = model;
                                    var filename = param;
                                    return view_button(filename, /* Fetch */variant("Fetch", 8, ["Life/" + (model$1.directory + ("/" + filename))]));
  ...
  function subscriptions(param) {
    return downs(undefined, (function (k) {
                  return /* KeyPressed */variant("KeyPressed", 9, [k]);
                }));
  }
  ...
  function update$2(state, $$event) {
    ...
    if (exit$1 === 1) {
      cmd = state$1.geo === /* Infinite */0 ? msg(/* Clamp */6) : /* NoCmd */0;
    }
    return /* tuple */[
            state$1,
            cmd
