(function () {
  ...
  function node(tagName, $staropt$star, $staropt$star$1, props, nodes) {
    ...
    return fullnode(svgNamespace, tagName, key, unique, props, nodes);
  }
  ...
  function canvas($staropt$star, $staropt$star$1, props, nodes) {
    var key = $staropt$star !== undefined ? $staropt$star : "";
    var unique = $staropt$star$1 !== undefined ? $staropt$star$1 : "";
    return fullnode("", "canvas", key, unique, props, nodes);
  }
  ...
  function draw_svg(state) {
    var cells = mapij((function (i, j, e) {
            var i$1 = i;
            var j$1 = j;
            var e$1 = e;
            var w = 100 / width(state.board);
            var h = 100 / height(state.board);
            var x = i$1 * w;
            var y = j$1 * h;
            return node("rect", undefined, undefined, /* :: */simpleVariant("::", [
                          attribute("", "x", x.toPrecision(4)),
                          /* :: */simpleVariant("::", [
                              attribute("", "y", y.toPrecision(4)),
                              /* :: */simpleVariant("::", [
                                  attribute("", "width", w.toPrecision(4)),
                                  /* :: */simpleVariant("::", [
                                      attribute("", "height", h.toPrecision(4)),
                                      /* :: */simpleVariant("::", [
                                          attribute("", "fill", e$1 === /* Alive */1 ? "black" : "white"),
                                          /* :: */simpleVariant("::", [
                                              attribute("", "stroke-width", "0.5"),
                                              /* :: */simpleVariant("::", [
                                                  attribute("", "stroke", "pink"),
                                                  /* :: */simpleVariant("::", [
                                                      onClick(/* Flip */variant("Flip", 0, [
                                                              i$1,
                                                              j$1
    ...
    return /* :: */simpleVariant("::", [
              svg(undefined, undefined, /* :: */simpleVariant("::", [
                      attribute("", "viewBox", "0 0 100 100"),
                      /* [] */0
                    ]), flatten(to_list(map$1(to_list, cells)))),
              /* [] */0
            ]);
  }

  function draw_canvas(state) {
    var matrix_width = width(state.board);
    var matrix_height = height(state.board);
    return /* :: */simpleVariant("::", [
              canvas(undefined, undefined, /* :: */simpleVariant("::", [
                      attribute("", "width", "800"),
                      /* :: */simpleVariant("::", [
  ...
  function view_button(title, msg) {
    return button(undefined, undefined, /* :: */simpleVariant("::", [
                  onClick(msg),
                  /* :: */simpleVariant("::", [
                      class$prime("btn btn-light flex-1"),
                      /* [] */0
                    ])
                ]), /* :: */simpleVariant("::", [
                  text(title),
  ...
  function auto_clamp_button(model) {
    ...
    return view_button(text, /* SetAutoClamp */5);
  }
  ...
  function select_rule(model) {
    var rules_option = function (param) {
      ...
      return option$prime(undefined, undefined, /* :: */simpleVariant("::", [
                    ...
                    /* :: */simpleVariant("::", [
                        onClick(/* SetRule */variant("SetRule", 2, [rule])),
                        /* [] */0
                      ])
                  ]), /* :: */simpleVariant("::", [
                    text(param[0]),
    ...
    return select(undefined, undefined, /* [] */0, map(rules_option, /* :: */simpleVariant("::", [
                      /* tuple */[
                        "B3S23",
                        /* B3S23 */0,
                        0
  ...
  function select_backend(model) {
    var backend_option = function (param) {
      ...
      return option$prime(undefined, undefined, /* :: */simpleVariant("::", [
                    ...
                    /* :: */simpleVariant("::", [
                        onClick(/* SetBackend */variant("SetBackend", 3, [backend])),
                        /* [] */0
                      ])
                  ]), /* :: */simpleVariant("::", [
                    text(param[0]),
    ...
    return select(undefined, undefined, /* [] */0, map(backend_option, /* :: */simpleVariant("::", [
                      /* tuple */[
                        "Html",
                        /* Html */0,
                        0
  ...
  function file_menu(model) {
    var directories = map((function (param) {
            return param[0];
          }), list$1);
      ...
      return div(undefined, undefined, /* [] */0, /* :: */simpleVariant("::", [
                    div(undefined, undefined, /* :: */simpleVariant("::", [
                            ...
                            /* [] */0
                                ...
                                return view_button(e, /* SetDirectory */variant("SetDirectory", 4, [e]));
                              }), directories)),
                    /* :: */simpleVariant("::", [
                        div(undefined, undefined, /* :: */simpleVariant("::", [
                                class$prime("menu flex"),
                                /* [] */0
                                    ...
                                    var model$1 = model;
                                    var filename = param;
                                    return view_button(filename, /* Fetch */variant("Fetch", 6, ["Life/" + (model$1.directory + ("/" + filename))]));
                                  }), files_from_dir(model.directory))),
                        /* [] */0
                      ])
                  ]));
    } else {
      return div(undefined, undefined, /* [] */0, /* [] */0);
    }
  }
                                  ...
                                  /* :: */simpleVariant("::", [
                                      ...
                                      /* :: */simpleVariant("::", [
                                          ...
                                          /* :: */simpleVariant("::", [
                                              ...
                                              /* :: */simpleVariant("::", [
                                                  view_button("Resize", /* Clamp */4),
                                                  /* :: */simpleVariant("::", [
                                                      auto_clamp_button(model),
                                                      /* :: */simpleVariant("::", [
                                                          view_button("Patterns", /* SetShowPattern */6),
                                                          /* [] */0
                                                        ])
                                                    ])
                                                ])
  ...
  function reset(board) {
    return make$2(width(board), height(board), /* Dead */0);
  }
  ...
  function lifeData(param_0) {
    return /* LifeData */variant("LifeData", 7, [param_0]);
  }

  var rule_list = /* :: */simpleVariant("::", [
      /* tuple */[
        "B3S23",
        /* B3S23 */0,
        0
  ...
  var backend_list = /* :: */simpleVariant("::", [
      /* tuple */[
        "Html",
        /* Html */0,
        0
  ...
  function registerGlobal(name, key, tagger) {
    var enableCall = function (callbacks_base) {
      ...
      var handler = /* EventHandlerCallback */variant("EventHandlerCallback", 0, [
          key,
          fn
        ]);
      var elem = document;
  ...
  function subscriptions(param) {
    return downs(undefined, (function (k) {
                  return /* KeyPressed */variant("KeyPressed", 5, [k]);
                }));
  }
  ...
  function update$2(state, $$event) {
    ...
    if (typeof $$event === "number") {
      ...
      switch ($$event.tag | 0) {
        ...
        case /* KeyPressed */5 :
            var k = $$event[0];
            cmd = k.key_code === 13 || k.key_code === 32 ? msg(/* Next */2) : /* NoCmd */0;
            break;
        case /* Fetch */6 :
    ...
    if (exit$1 === 1) {
      cmd = state$1.geo === /* Infinite */0 ? msg(/* Clamp */4) : /* NoCmd */0;
    }
    return /* tuple */[
            state$1,
            cmd
