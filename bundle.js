...
function findi(f, a) {
  ...
  while(true) {
    ...
    if (_1(f$1, caml_array_get(a$1, i))) {
      return i;
    } else {
      _i = i + 1 | 0;
      continue ;
...
function rules(model) {
  return cons(select(undefined, undefined, /* :: */[
                  onChange(undefined, (function (i) {
                          var match = caml_int_of_string(i);
                          if (match !== 0) {
                            return /* SetRule */__(8, [/* B36S23 */1]);
                          } else {
                            return /* SetRule */__(8, [/* B3S23 */0]);
                          }
                        })),
                  /* [] */0
                ], /* :: */[
                  option$prime(undefined, undefined, /* :: */[
                        value$1("0"),
                        /* :: */[
                          Attributes.selected(model.rule === /* B3S23 */0),
                          /* [] */0
                        ]
                      ], /* :: */[
                        text("B3S23"),
                  ...
                  /* :: */[
                    option$prime(undefined, undefined, /* :: */[
                          value$1("1"),
                          /* :: */[
                            Attributes.selected(model.rule === /* B36S23 */1),
                            /* [] */0
                          ]
                        ], /* :: */[
                          text("B36S23"),
  ...
  if (typeof $$event === "number") {
    switch ($$event) {
      ...
      case /* Previous */2 :
          ...
          board = match ? match[0] : make$1(0, 0, /* Dead */0);
          break;
      case /* Clamp */4 :
          board = clamp(state.board);
          break;
      case /* Reset */5 :
          board = make$1(width(state.board), height$1(state.board), /* Dead */0);
          break;
      default:
        board = state.board;
    }
...
export { init, main, subscriptions, update$2 as update };
