...
function update$1(state, $$event) {
  ...
  if (typeof $$event === "number") {
    switch ($$event) {
      ...
      case /* Clamp */4 :
          ...
          break;
      case /* Reset */5 :
          board = make$1(state.size.x, state.size.y, /* Dead */0);
          break;
      default:
        board = state.board;
    }
  ...
  var cmd = typeof $$event === "number" ? (
      $$event !== 4 && state.auto_clamp ? msg(/* Clamp */4) : /* NoCmd */0
    ) : (
      state.auto_clamp ? msg(/* Clamp */4) : /* NoCmd */0
    );
  return /* tuple */[
          board,
          cmd
...
function view(model) {
  return div$1(undefined, undefined, /* :: */[
              ...
              div$1(undefined, undefined, /* :: */[
                  ...
                  ], cons(select(undefined, undefined, /* :: */[
