...
function seed_link(param) {
  return Tea_html.div(undefined, undefined, /* [] */0, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                Tea_html.a(undefined, undefined, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                        Tea_html.href("#"),
                        /* :: */Caml_chrome_debugger.simpleVariant("::", [
                            Tea_html.onClick(/* Fetch */Caml_chrome_debugger.variant("Fetch", 6, [param[1]])),
                            /* [] */0
                          ])
                      ]), /* :: */Caml_chrome_debugger.simpleVariant("::", [
...
function select_rule(model) {
  var rules_option = function (param) {
    ...
    return Tea_html.option$prime(undefined, undefined, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  ...
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      Tea_html.onClick(/* SetRule */Caml_chrome_debugger.variant("SetRule", 2, [rule])),
                      /* [] */0
                    ])
                ]), /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  Tea_html.text(param[0]),
  ...
  return Tea_html.select(undefined, undefined, /* [] */0, List.map(rules_option, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* tuple */[
                      "B3S23",
                      /* B3S23 */0,
                      0
...
function select_backend(model) {
  var backend_option = function (param) {
    var backend = param[1];
    return Tea_html.option$prime(undefined, undefined, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  Tea_html.Attributes.selected(model.backend === backend),
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      Tea_html.onClick(/* SetBackend */Caml_chrome_debugger.variant("SetBackend", 3, [backend])),
                      /* [] */0
                    ])
                ]), /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  Tea_html.text(param[0]),
  ...
  return Tea_html.select(undefined, undefined, /* [] */0, List.map(backend_option, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                    /* tuple */[
                      "Html",
                      /* Html */0,
                      0
    ...
    return Tea_html.div(undefined, undefined, /* [] */0, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                  Tea_html.div(undefined, undefined, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          ...
                          /* [] */0
                              ...
                              return view_button(e, /* SetDirectory */Caml_chrome_debugger.variant("SetDirectory", 4, [e]));
                            }), directories)),
                  /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      Tea_html.div(undefined, undefined, /* :: */Caml_chrome_debugger.simpleVariant("::", [
                              Tea_html.class$prime("menu flex"),
                              /* [] */0
                                  ...
                                  var model$1 = model;
                                  var filename = param;
                                  return view_button(filename, /* Fetch */Caml_chrome_debugger.variant("Fetch", 6, ["Life/" + (model$1.directory + ("/" + filename))]));
