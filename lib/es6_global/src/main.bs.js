...
function subscriptions(param) {
  return Keyboard.downs(undefined, (function (k) {
                return /* KeyPressed */Caml_chrome_debugger.variant("KeyPressed", 9, [k]);
              }));
}
...
function update(state, $$event) {
  ...
  if (exit === 1) {
    state$1 = {
      ...
      geo: state.geo,
      backend: state.backend,
      previous: /* :: */Caml_chrome_debugger.simpleVariant("::", [
          state.board,
          state.previous
        ]),
      auto_clamp: state.auto_clamp,
  ...
  if (exit$1 === 1) {
    cmd = state$1.geo === /* Infinite */0 ? Tea_cmd.msg(/* Clamp */6) : /* NoCmd */0;
  }
  return /* tuple */[
          state$1,
          cmd
